...
import { FilePenIcon, PencilIcon, PlusIcon, Trash, TrashIcon, UploadCloud, XIcon } from 'lucide-react'
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <p className='text-2xl font-medium mb-6 bg-linear-to-r from-slate-600 to-slate-700 bg-clip-text text-transparent sm:hidden'>Welcome, Vinay</p>
          ...
          <form onSubmit={uploadResume} onClick={()=> setShowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <div>
                ...
                <input type="file" id="resume-input" accept=".json,.txt,.pdf,.doc,.docx" hidden onChange={(e)=> setResume(e.target.files[0])} required/>
              </div>
